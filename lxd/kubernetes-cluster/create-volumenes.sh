...
sleep 10
echo "Montando volumenes"
echo "worker1 ..."
lxc config device add kworker1 data1 disk source=/home/anynou/data path=/data/
echo "worker2 ..."
lxc config device add kworker2 data2 disk source=/home/anynou/data path=/data/
